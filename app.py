...
def especies_nombre(name):
    ...
    especieqr = [
        {
            "nombre": "HIERBABUENA",
            "descripcion": "Es una especie del género Mentha, una hierba aromática muy empleada en gastronomía y perfumería por su aroma intenso y fresco. Tiene propiedades útiles, antiespasmódicas, es carminativo, antiséptico, analgésico, antiinflamatorio y estimulante.",
            "imagen": "hierbabuena.jpg"
        },
        {
            "nombre": "SUCULENTA",
            "descripcion": "Se dan típicamente zonas secas y calurosas, donde el agua es escasa. Muchas de las especies de esta familia son populares en jardinería y floricultura; son plantas duras y requieren cuidados mínimos. Otra ventaja para el cultivo de estas plantas es lo habitualmente sencillo de su propagación, necesitándose en algunos casos una simple hoja para lograr un nuevo ejemplar.",
        ...
        {
            "nombre": "DALIA",
            "descripcion": "La dalia es una especie originaria de los bosques templados del Sur y Centro de México. Posee raíces en forma de camotes, los cuales son comestibles y medicinales, ahora se está cultivando en zonas rurales para producir té a partir de la misma.",
            "imagen": "dalia.jpg"
        },
        {
            "nombre": "ROMERO",
            "descripcion": "El romero es un arbusto aromático, leñoso, de hojas perennes, muy ramificado y ocasionalmente achaparrado y que puede llegar a medir 2 metros de altura. Se cría en todo tipo de suelos, preferiblemente los secos y algo arenosos y permeables, adaptándose muy bien a los suelos pobres. Crece en zonas litorales y de montaña baja.",
            "imagen": "romero.jpg"
        }
    ]
